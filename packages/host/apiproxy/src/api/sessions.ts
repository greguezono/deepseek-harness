...
export interface SessionsApi {
   ...
   * valid for non-browser callers. Archived sessions reject with `session-archived` before Agent
   * admission. Session-backed subagents reject with `agent-busy` and use `subagent.prompt`.
   */

...
export const zh = {
  ...
  'archived.label': '已归档',
  'archived.show': '显示已归档',
  'archived.heading': '已归档',
  'archived.readonly.title': '已归档会话',
  'archived.readonly.body': '可以查看消息，但不能发送。',
...
export const en = {
  ...
  'archived.show': 'Show archived',
  'archived.heading': 'Archived',
  'archived.readonly.title': 'Archived session',
  'archived.readonly.body': 'You can read messages, but you cannot send.',

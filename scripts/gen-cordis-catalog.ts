...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  mcpOAuth: 'credentials.md',
  mcpOAuthController: 'credentials.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  McpOAuthStatus: 'event payload contract is owned by packages/mcp/mcp-oauth/src/types.ts',
  McpOAuthEntry: 'service-local safe entry view is owned by packages/mcp/mcp-oauth/src/types.ts',
  McpOAuthBinding: 'service-local binding contract is owned by packages/mcp/mcp-oauth/src/index.ts',
  McpOAuthRegistration: 'service-local registration input is owned by packages/mcp/mcp-oauth/src/index.ts',
  McpOAuthCredentialId: 'branded credential id is owned by packages/mcp/mcp-oauth/src/types.ts',
  AuthorizationEntryView: 'wire view contract is owned by packages/api/authorization-controller/src/types.ts',
  AuthorizationBeginRequest: 'wire request contract is owned by packages/api/authorization-controller/src/types.ts',
  AuthorizationBeginFrame: 'wire frame contract is owned by packages/api/authorization-controller/src/types.ts',
  AuthorizationRespondRequest: 'wire request contract is owned by packages/api/authorization-controller/src/types.ts',

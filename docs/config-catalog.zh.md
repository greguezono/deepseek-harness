...
来源：[`packages/mcp/mcp-client/src/index.ts:114`](../packages/mcp/mcp-client/src/index.ts)
...
- `@deepseek-ai/dsh-api-authorization-controller` — 需要 `authorization`（[`packages/api/authorization-controller/src/index.ts`](../packages/api/authorization-controller/src/index.ts)）
...
- `@deepseek-ai/dsh-mcp-oauth-web` — 需要 `credentials` · `authorization` · `webServer`（[`packages/mcp/mcp-oauth-web/src/index.ts`](../packages/mcp/mcp-oauth-web/src/index.ts)）
...
- `@deepseek-ai/dsh-mcp-oauth` — 抽象 `McpOAuthService`（[`packages/mcp/mcp-oauth/src/index.ts`](../packages/mcp/mcp-oauth/src/index.ts)）
